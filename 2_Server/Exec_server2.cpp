/////////////////////////////////////////////////////////////////////////////
// Exec_servcer2.cpp - demonstrating server functions                      //
// Ver 1.0                                                                 //
...
*  Package Operations:
*  -------------------
*  This package is the test executive package for server1 at localhost:9081
*
*  Required Files:
*  ---------------
...
int main()
{
	if (SetConsoleCtrlHandler((PHANDLER_ROUTINE)CtrlHandler, TRUE)){
		title("Starting Server: 2_server", '=');
		//server at localhost:9081
		Server server(9081, Socket::IpVer::IP4);
